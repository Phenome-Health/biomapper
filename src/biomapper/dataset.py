...
that wraps :meth:`biomapper.BioMapperClient.map_dataset_file_iter` with an
...
from biomapper.models import DatasetMappingResult, MappingResult
...
def map_dataset_file_sync(
    ...
    *,
    ...
    :meth:`biomapper.BioMapperClient.map_dataset_file_iter`, accumulates them
    into a :class:`~biomapper.models.DatasetMappingResult`, and returns once
    ...
    On ``on_result`` semantics:
        ...
        1. Call ``asyncio.run(...)`` or otherwise re-enter biomapper async
